...
SECRET_KEY = 'django-insecure-&#k72yp%o@m3352cp2v2g#e0e-h=nb&2nwam-lw+y=jfms@18%'
...
STATIC_URL = 'https://rarelane.azurewebsites.net/static/'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'interacter/static'),
]
